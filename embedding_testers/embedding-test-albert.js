...
async function main() {
    ...
    const modelPath = path.join(__dirname, 'public', 'models', 'paraphrase-albert-small-v2');
    const extractor = await pipeline('feature-extraction', 'Xenova/paraphrase-albert-small-v2', {
        quantized: false,
        local: modelPath
    });
